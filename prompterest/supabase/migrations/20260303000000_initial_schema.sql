...
-- 1. PROFILES Table (Manejada en migración posterior 104000)
...
-- alter table public.profiles enable row level security; (Manejado en migración posterior)
...
ALTER TABLE public.prompts ADD COLUMN blur_hash TEXT;
